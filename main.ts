System.register(["./Persona", "./Direcciones", "./Mails", "./Telefono"], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            primeraResidenciaMaria = new direccion_1.Direcciones("Calle Ángel Ganivet", 34, 4, "B", 50008, "Zaragoza", "Zaragoza");
            segundaResidenciaMaria = new direccion_1.Direcciones("Calle Paciencia", 4, false, false, 50300, "Calatayud", "Zaragoza");
            mailMaria = new mail_1.Mails("personal", "aparicioMaria@gmail.com");
            ...
            primeraResidenciaFederico = new direccion_1.Direcciones("Calle Hierbabuena", 2, 1, "A", 42190, "Las Camaretas", "Soria");
            segundaResidenciaFederico = new direccion_1.Direcciones("Calle Merineros", 23, 1, "A", 42001, "Soria", "Soria");
            mailPersonalFederico = new mail_1.Mails("personal", "elfededesoria@hotmail.com");
            mailTrabajoFederico = new mail_1.Mails("personal", "federico@gonzalezasociados.com");
            ...
            primeraResidenciaIsmael = new direccion_1.Direcciones("Calle Juan Ramón Jiménez", 19, 9, "C", 41011, "Sevilla", "Sevilla");
            segundaResidenciaIsmael = new direccion_1.Direcciones("Calle Santiago Rusiñol", 8, 1, "A", 11520, "Rota", "Cádiz");
            mailPersonalIsmael = new mail_1.Mails("personal", "ismaeldelospuentes@gmail.com");
            mailTrabajoIsmael = new mail_1.Mails("trabajo", "ipuentes@ttds.es");
            ...
            nuevaDireccion = new direccion_1.Direcciones("Calle Dr. Gómez Ferrer", 35, 1, false, 444000, "Mora de Rubielos", "Teruel");
            nuevoMail = new mail_1.Mails("trabajo", "turismodecalatayud@calatayud.org");
